...
#confint btwn competitors in sight and no competitors in sight
filteredGas <- gas %>%
...
Conclusion: The difference in price between gas stations with competition in sight and no competition is somewhere between 0.396 and 0.594 cents, with 95% confidence. This theory is supported by the data. Since this confidence interval does not include the value 0, it is statistically significant. We can attribute the price of gas at this sample of gas stations to the existence of direct competition in sight. This conclusion can be attributed to reasons other than chance. 
